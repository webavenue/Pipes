...
namespace UTNotifications
{
    public sealed class XmlUtils
    {
        ...
        public static bool RemoveElement(XmlDocument document, XmlNode parent, string name, string attributeName = null, string ns = null, string value = null, string commentText = null, string elementNs = null)
        {
            XmlNode previous;
            XmlElement element = FindElement(out previous, parent, name, attributeName, ns, value);
            if (element != null)
            {
                if (commentText != null && previous != null && previous is XmlComment && ((XmlComment)previous).Data.Trim() == commentText)
                {
